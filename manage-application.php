...
<main class="content" id="content">
    <div class="manageapplication-container">
        <h1 class="manageapplication-title">Manage the application</h1>
        <div class="application-cards">
            <div class="application-card">
                <div class="card-icon">
                    <img src="Images/userss.png" class="icons" alt="Users Icon">
            </div>
            <a href="manageusers-admin.php" class="applicationcard-text">Manage Users</a>
         </div>
         ...
         <div class="application-card">
            ...
            <a href="manageservices-admin.php" class="applicationcard-text">Manage Services</a>
         </div>
           ...
           <div class="application-card">
            ...
            <a href="managebookings-admin.php" class="applicationcard-text">Manage Bookings</a>
         </div>
    </div>
    </main>
    </div>
