...
$stmt = $mysqli->prepare("SELECT name, email, location, types, role, profilepicture, profiledescription FROM user WHERE id = ?");
...
<main class="content" id="content">
    ...
    <?php if (isset($_GET['updated'])): ?>
            <div id="pm" class="popup-message">Your profile has been updated</div>
            <?php endif; ?>
