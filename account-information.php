...
$stmt = $mysqli->prepare("SELECT name, email, location, role, profilepicture, profiledescription FROM user WHERE id = ?");
...
<main class="content" id="content">
    <div class="accountinformation-container">
        <h1 class="accountinformation-title">Delete Account</h1>
        <div class="accountdelete-card">
            <div class="accountdelete-container">
                <p class="accountdelete-text">
                    Please note if you do wish to delete your account, all bookings and services will be deleted and need to be made again.
                </p>
                <form action="delete-account-process.php" method="POST">
                <button type="submit" class="account-button">Delete</button>
                </form>
            </div>
        </div>
