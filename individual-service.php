...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$service_id) {
        die("Missing service ID or booking date/time.");
    }

    $stmt = $mysqli->prepare("INSERT INTO bookings (client_id, service_id, bookingdatetime, additionalinformation) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("iiss", $user_id, $service_id, $bookingdatetime, $additionalinformation);
    $stmt->execute();
        ...
        <button class="mobileview" id="closebutton">
         ...
         <div class="logo">
            ...
            <nav class="navbar-links">
                ...
                <a href="add-booking.php" class="navbar-link">My bookings</a>
...
<main class="content" id="content">
        ...
        <div class="form-container">
            <p class="form-title">Add Booking</p>
            <form method="POST">
            ...
            <div class="input-text">
                ...
                <textarea class="description" name="additionalinformation"></textarea>
            </div>
