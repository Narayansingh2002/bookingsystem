...
<main class="content" id="content">
      <div class="screen-container">
        <div class="form-container">
            ...
            <form action="update-booking-process.php" method="POST">
            ...
            <div class="input-text">
                ...
                <textarea class="description" name="additionalinformation" <?= htmlspecialchars($booking['additionalinformation']) ?>></textarea>
            </div>
            <div class="input-text">
                <label for="bookingdatetime">Date</label>
                <input type="datetime-local" name="bookingdatetime" value="<?= date('Y-m-d\TH:i', strtotime($booking['bookingdatetime'])) ?>">
            </div>
